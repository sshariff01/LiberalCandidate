...
jQuery(document).ready(function($) {
    ...
    $('#socket .sociable-ico a').tooltip({placement: 'bottom', animation: true});
    $('.sharebox .sociable-ico a').tooltip({placement: 'top'});
    $('.member-sociable a').tooltip({placement: 'top'});
    $('#copyright .sociable-ico a').tooltip({placement: 'top'});
    $('.sociable-ico a').tooltip({placement: 'top'});
